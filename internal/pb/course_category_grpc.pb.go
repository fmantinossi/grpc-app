...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamBiDirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryRequest, Category], error)
...
func (c *categoryServiceClient) CreateCategoryStreamBiDirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBiDirectionalClient = grpc.ClientStreamingClient[CreateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamBiDirectional(grpc.ClientStreamingServer[CreateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBiDirectional(grpc.ClientStreamingServer[CreateCategoryRequest, Category]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBiDirectionalServer = grpc.ClientStreamingServer[CreateCategoryRequest, Category]
